...
const Agenda = require('./models/agenda.js'); // Importación directa sin destructuring
const Profesion = require('./models/profesion.js'); // Importación directa sin destructuring
  ...
  fields: {
    ...
    profesion: {
      ...
      async resolve(parent) {
        return await Profesion.findByPk(parent.profesion_id)
      } 
    }
  }
});
...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    ...
    profesiones: {
      type: new GraphQLList(ProfesionType),
      resolve(parent, args) {
        // Obtener todas las agendas
    ...
    profesion: {
      ...
      resolve(parent, args) {
        // Buscar una agenda por ID
        return Profesion.findByPk(args.id);
      }
    }
  }
});
